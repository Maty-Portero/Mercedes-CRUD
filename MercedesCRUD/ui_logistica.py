...
from PySide6.QtWidgets import (QApplication, QLabel, QLineEdit, QPushButton,
        QSizePolicy, QWidget, QTableWidget)
...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.table_logistica = QTableWidget(Widget)
        self.table_logistica.setObjectName(u"table_logistica")
        self.table_logistica.setGeometry(QRect(60, 147, 1800, 900))
        self.table_logistica.setStyleSheet(u"background-color: white;\n"
"    border: 2px solid #ffffff;\n"
"    border-radius: 30px; /* Bordes redondeados */\n"
"    padding: 5px;")
        self.table_logistica.setColumnCount(0)
        self.table_logistica.setRowCount(0)
...
"    padding: 5px;")
    ...
    def retranslateUi(self, Widget):
        ...
        # table_logistica shows the sector data; no textual content to set here
        self.botonAgregar.setText(QCoreApplication.translate("Widget", u" Agregar Pedido", None))
        self.label_12.setText(QCoreApplication.translate("Widget", u"LOGISTICA", None))
        self.label_13.setText(QCoreApplication.translate("Widget", u"Usuario", None))
        self.label_7.setText("")
        self.label_14.setText(QCoreApplication.translate("Widget", u"Pedidos: {total}", None))
        self.label.setText("")
        ...
        self.label_38.setText(QCoreApplication.translate("Widget", u"OC- #0001", None))
        self.label_39.setText(QCoreApplication.translate("Widget", u"OC - #0002", None))
        self.label_40.setText(QCoreApplication.translate("Widget", u"PP - #ACEGA", None))
