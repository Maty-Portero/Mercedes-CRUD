...
"    padding: 5px;")
    ...
    def retranslateUi(self, Widget):
        ...
        self.botonAgregar.setText(QCoreApplication.translate("Widget", u" Agregar Medios", None))
        self.label_12.setText(QCoreApplication.translate("Widget", u"MARKETING", None))
        self.label_13.setText(QCoreApplication.translate("Widget", u"Usuario", None))
        self.label_7.setText("")
        self.label_14.setText(QCoreApplication.translate("Widget", u"Medios: {total}", None))
        self.label.setText("")
        ...
        self.label_38.setText(QCoreApplication.translate("Widget", u"Campa\u00f1as de Facebook", None))
        self.label_39.setText(QCoreApplication.translate("Widget", u"Campa\u00f1as de Instagram", None))
        self.label_40.setText(QCoreApplication.translate("Widget", u"Campa\u00f1a de Youtube", None))
