...
"    padding: 5px;")
    ...
    def retranslateUi(self, Widget):
        ...
        self.label_39.setText(QCoreApplication.translate("Widget", u"Transistores", None))
        self.label_40.setText(QCoreApplication.translate("Widget", u"Mesa de Oficina", None))
